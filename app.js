...
async function loadMorningGreeting() {
  ...
  let timeGreet = 'Shishishi! Ready to sail, nakama?'
  if (hour < 12) timeGreet = "Shishishi! Good morning nakama! What adventure awaits today?!"
  else if (hour < 17) timeGreet = "Shishishi! Good afternoon nakama! Don't slack off!"
  else timeGreet = "Shishishi! Good evening nakama! Rest up for tomorrow's adventure!"
